...
double Nigerian_Naira = 982.48;
double Brazilian_Real = 6.09;
double Canadian_Dollar = 1.69;
double Kenyan_Shilling = 180.76;
double Indonesian_Rupiah = 19187.15;
double Indian_Rupee = 104.67;
double Philippine_Pisco = 70.16;
double Pakistani_Rupee = 361.90;
...
"Paskistani Rupee"
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(3, 3, 2), 5));

        jLabel1.setFont(new java.awt.Font("Helvectica", 1, 26)); 
        jLabel1.setText("Currency Converter");

        firstCountry.setFont(new java.awt.Font("Tahoma", 1, 20)); 
        ...
        secondCountry.setFont(new java.awt.Font("Tahoma", 1, 20)); 
        ...
        t1.setFont(new java.awt.Font("Calibri", 1, 18)); 

        t2.setFont(new java.awt.Font("Calibri", 1, 18)); 
        ...
        jButton2.setFont(new java.awt.Font("Georgia", 1, 20)); 
        ...
        jButton3.setFont(new java.awt.Font("Impact", 1, 20)); 
        ...
        secondCurrencyUnit.setFont(new java.awt.Font("Impact", 1, 16)); 
        secondCurrencyUnit.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        secondCurrencyUnit.setText("units");

        firstCurrencyUnit.setFont(new java.awt.Font("Impact", 1, 16)); 
